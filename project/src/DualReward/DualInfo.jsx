...
import lamb from '../assets/FarmIcons/lamb0.png'
...
<Box fontFamily='heading' mt={5} padding={3} paddingBottom={1} width={250} bgColor='gray.900' fontWeight='semibold' color='gray.300' borderBottom='none'>                
    <HStack>
        <Image src={token0 == '0x536c730d891bE8d573248939a5B6806b9f4716FA' ? ggc 
                    : token0 == '0x937D1e338aF3B6e13901e5f054B4316fbbfC024c' ? lamb
                    : ggc}
                mb={3}>
        </Image>
        <Image src={token1 == '0x536c730d891bE8d573248939a5B6806b9f4716FA' ? ggc 
                    : token1 == '0x937D1e338aF3B6e13901e5f054B4316fbbfC024c' ? lamb
                    : ggc}
                mb={3}>
        </Image>    
    ...
    <Center borderBottom='2px' borderColor='yellow.500'></Center>
                <HStack mb={1} mt={3}> 
                    ...
                    <Flex ml='auto' mr={1} fontSize='medium'>
                        Atrofa + Lamb0
                    </Flex>
                </HStack>
                <HStack mb={1} mt={3}> 
                ...
                <HStack color='gray.400' mb={1} mt={0}> 
                ...
                <HStack color='gray.400' mb={1} mt={-1}> 
                    <Flex ml={1} mr='auto' fontSize='smaller'>
                        Lamb0: 
                    </Flex>
                    <Flex ml='auto' mr={1} fontSize='sm'>
                ...
                <HStack color='gray.400' mb={1} mt={0}> 
                    ...
                    <Flex ml='auto' mr={1} fontSize='sm'>
                        ${(userStakedUsd / 10**18 * atrofaApr / 100 / 365).toFixed(2)}
                    </Flex>
                </HStack>
                <HStack color='gray.400' mb={3} mt={-1}> 
                    <Flex ml={1} mr='auto' fontSize='smaller'>
                        Lamb0: 
                    </Flex>
                    <Flex ml='auto' mr={1} fontSize='sm'>
                        ${(userStakedUsd / 10**18 * lambApr / 100 / 365).toFixed(2)}
                    </Flex>
                </HStack>
                <HStack >
                ...
                <Flex justify='right' mr={1} mb={1} mt={-1} fontSize='smaller' fontWeight='light'>
                    {token0Staked>1000000000 ? parseFloat(token0Staked).toExponential(2) + " GGC"
                      : parseFloat(token0Staked).toFixed(2) + " GGC"}    
                </Flex>
                <Flex justify='right' mr={1} mb={1} mt={-1} fontSize='smaller' fontWeight='light'>
                    {token1Staked>1000000000 ? parseFloat(token1Staked).toExponential(2) + " lamb0"
                      : parseFloat(token1Staked).toFixed(2) + " lamb0"}
                </Flex>
                ...
                <HStack>
                    ...
                    <Flex ml='auto' mr={1} fontSize='large'>
                        ${(parseInt(totalReward) /10**18).toFixed(2)}
                    </Flex>
                </HStack>
                <HStack color='gray.400' mb={1} mt={0}> 
                    <Flex ml={1} mr='auto' fontSize='smaller'>
                    ...
                    <Flex ml='auto' mr={1} fontSize='sm'>
                        {(parseInt(atrofaRewards)/10**18).toFixed(2)}
                    </Flex>
                </HStack>
                <Flex justify='right' mr={1} mt={-1} fontSize='smaller' fontWeight='light'>
                    ${(parseInt(atrofaRewardsUsd)/10**18).toFixed(2)}
                </Flex>
                <HStack color='gray.400' mb={1} mt={0}> 
                    <Flex ml={1} mr='auto' fontSize='smaller'>
                        Lamb0: 
                    ...
                    <Flex ml='auto' mr={1} fontSize='sm'>
                        {(parseInt(dualRewards)/10**18).toFixed(2)}
                    </Flex>
                </HStack>
                <Flex justify='right' mr={1} mt={-1} fontSize='smaller' fontWeight='light'>
                    ${(parseInt(dualRewardsUsd)/10**18).toFixed(2)}
                </Flex>
                </Box>
